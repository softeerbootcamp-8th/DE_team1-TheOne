...
차트 계열색(SERIES)은 `dataviz` 검증기를 통과한 조합만 쓴다.
    ...
    다크  (표면 #181F28, all-pairs): 최악 CVD ΔE 8.7 / 정상시야 19.9
어긋난 표면색(#1B1E29)을 실제 값으로 바로잡았다. 두 색은 상대휘도 차이가
0.00006 이고 계열색 대비비가 최대 0.01 밖에 안 달라져 위 수치는 그대로 유효하다
(대비비 재측정: series 3.79~5.43, neutral_mark 3.50 — 모두 3:1 통과).
