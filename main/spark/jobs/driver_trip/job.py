...
사용 예:
    cd main/spark && PYTHONPATH="../..:../../libs/pipeline_core" \\
      uv run --frozen python -m main.spark.jobs.driver_trip.job \\
...
from main.spark.jobs.driver_trip.transformer import build_driver_trip
