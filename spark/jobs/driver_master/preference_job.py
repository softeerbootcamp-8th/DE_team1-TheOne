...
사용 예:
    cd spark && PYTHONPATH="$(pwd):$(pwd)/.." uv run --frozen python jobs/driver_master/preference_job.py
"""
...
from jobs.driver_master.preference import build_driver_preferences, write_driver_preferences
from jobs.driver_master.traits import load_bootstrap_pools
from scripts.synthetic_company_snapshot.snapshot import build_driver_ids
