...
사용 예 (spark/jobs/bronze_to_silver/hvfhv/job.py와 동일한 PYTHONPATH 패턴):
    cd spark && PYTHONPATH="$(pwd):$(pwd)/.." uv run --frozen python jobs/driver_master/job.py
"""
...
from jobs.driver_master.aggregate import build_driver_master_table
from jobs.driver_master.traits import load_bootstrap_pools, sample_driver_traits
