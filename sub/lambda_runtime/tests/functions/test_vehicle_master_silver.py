...
from sub.lambda_runtime.functions.vehicle_master_silver.handler import lambda_handler as to_master
from sub.lambda_runtime.functions.vehicle_master_silver.loader import SCHEMA
