...
from sub.lambda_runtime.functions.uber_eligible_vehicles_bronze_to_silver.handler import (
...
def test_조인_키가_차량_대장과_같은_규칙으로_만들어진다(tmp_path):
    ...
    from sub.lambda_runtime.functions.vehicle_catalog_bronze_to_silver.transformer import (
