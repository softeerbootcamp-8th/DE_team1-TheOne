...
from sub.aws_lambda.common import lyft_eligible_vehicles_layout as lyft_layout
from sub.aws_lambda.common import uber_eligible_vehicles_layout as uber_layout
