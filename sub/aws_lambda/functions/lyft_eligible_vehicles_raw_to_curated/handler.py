"""Lyft 배차 가능 차량 목록을 Raw에서 Curated로 변환합니다."""
...
from .transformer import LyftEligibleVehiclesCuratedTransformer
...
def lambda_handler(event: dict | None = None, context=None) -> dict:
    ...
    result = Pipeline(
        ...
        loader,
        transformer=LyftEligibleVehiclesCuratedTransformer(),
    ).run()
