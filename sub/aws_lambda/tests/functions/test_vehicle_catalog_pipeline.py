...
from sub.aws_lambda.functions.vehicle_catalog_raw_to_bronze import extractor as raw_extractor
from sub.aws_lambda.functions.vehicle_catalog_raw_to_bronze.handler import lambda_handler as to_bronze
