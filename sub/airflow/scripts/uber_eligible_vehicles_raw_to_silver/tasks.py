...
def raw_to_bronze_task(**context) -> dict:
    ...
    result = lambda_handler_for("uber_eligible_vehicles_raw_to_bronze", package="sub.aws_lambda.functions")(
        event={
...
def bronze_to_silver_task(raw_result: dict, **context) -> dict:
    ...
    result = lambda_handler_for("uber_eligible_vehicles_bronze_to_silver", package="sub.aws_lambda.functions")(
        event={
...
def validate_bronze_task(result: dict, **context) -> None:
    ...
    transformer = importlib.import_module(
        "sub.aws_lambda.functions.uber_eligible_vehicles_bronze_to_silver.transformer"
    )
