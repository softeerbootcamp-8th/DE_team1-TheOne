...
from dags import uber_eligible_vehicles_raw_to_curated_dag as dag_module
from sub.airflow.scripts.uber_eligible_vehicles_raw_to_curated import tasks as task_module

DAG = dag_module.uber_eligible_vehicles_dag
DAG_ID = "uber_eligible_vehicles_raw_to_curated_pipeline"
RAW_FUNCTION = "uber_eligible_vehicles_source_to_raw"
CURATED_FUNCTION = "uber_eligible_vehicles_raw_to_curated"
