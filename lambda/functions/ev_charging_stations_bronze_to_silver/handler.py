"""전기차 충전소 일별 Bronze JSON을 월별 Silver Parquet으로 변환합니다."""
...
from .loader import EvChargingSilverLoader
...
def lambda_handler(event: dict | None = None, context=None) -> dict:
    ...
    loader = EvChargingSilverLoader(silver_dir, collected_month)
    result = Pipeline(
        EvChargingBronzeExtractor(bronze_dir, collected_month),
        loader,
